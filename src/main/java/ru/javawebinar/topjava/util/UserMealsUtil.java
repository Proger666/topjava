...
public class UserMealsUtil {
    ...
    public List<UserMealWithExceed> getFilteredMeals(){
        return getFilteredMealsWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(22, 0), 2050);
    }

    private List<UserMealWithExceed>  getFilteredMealsWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
